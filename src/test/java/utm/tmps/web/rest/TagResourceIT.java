...
class TagResourceIT {
    ...
    public static Tag createEntity(EntityManager em) {
        Tag tag = new Tag().name(DEFAULT_NAME).iconName(DEFAULT_ICON_NAME).color(DEFAULT_COLOR);
        return tag;
    }
    ...
    public static Tag createUpdatedEntity(EntityManager em) {
        Tag tag = new Tag().name(UPDATED_NAME).iconName(UPDATED_ICON_NAME).color(UPDATED_COLOR);
        return tag;
    }
    ...
    void createTag() throws Exception {
        ...
        assertThat(testTag.getIconName()).isEqualTo(DEFAULT_ICON_NAME);
    ...
    void putExistingTag() throws Exception {
        ...
        updatedTag.name(UPDATED_NAME).iconName(UPDATED_ICON_NAME).color(UPDATED_COLOR);
        ...
        assertThat(testTag.getIconName()).isEqualTo(UPDATED_ICON_NAME);
    ...
    void fullUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.name(UPDATED_NAME).iconName(UPDATED_ICON_NAME).color(UPDATED_COLOR);
