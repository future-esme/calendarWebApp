...
import { EntityArrayResponseType, UserTagsService } from '../service/user-tags.service';
...
export class UserTagsComponent implements OnInit {
  ...
  delete(tag: ITag): void {
    const modalRef = this.modalService.open(UserTagsDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
