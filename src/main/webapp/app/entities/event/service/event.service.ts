...
type RestOf<T extends IEvent | NewEvent> = Omit<T, 'startTime' | 'endTime' | 'notificationTime'> & {
...
export class EventService {
  ...
  protected convertDateFromServer(restEvent: RestEvent): IEvent {
    return {
      ...
      notificationTime: restEvent.notificationTime ? dayjs(restEvent.notificationTime) : undefined,
    };
  }
